...
public interface CustomerDao extends CrudRepository<Customer, Long> {
    ...
    @Query("select new com.spring.aurora.entity.CustomerWithPrice(c.customerId, c.type, c.name, c.address, c.contactName, c.mainNumber, c.alternateNumber, c.emailAddress, c.orderInterval, c.totalRound, c.totalSlim, cp.productId, cp.sellingPrice) from Customer as c, CustomerPrice as cp where c.customerId = cp.customerId")
